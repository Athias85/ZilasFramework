...
class Zf_QueryGenerator
{
	...
	public function __construct($connect = true, $database = null, $server = null,
                ...
                /**
                 * Here we require the AdoDB database wrapper library which is vital
                 * for executing multi-database queries.
                 */
                require_once ZF_PLUGINS."adodb5/adodb.inc.php";
